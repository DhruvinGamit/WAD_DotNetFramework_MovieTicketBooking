<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="Movie_Ticket_Booking.Admin" %>
...
&nbsp;&nbsp;&nbsp; ADMIN LOGIN</p>
            ...
            <div class="form-group">
                <asp:Button ID="LoginBtn" runat="server" CssClass="login-button" Text="LOGIN" OnClick="AdminLoginBtn_Click" />
            </div>
            ...
            <br /><br />
            <div class="auto-style2">
                Are you User? <a href="Login.aspx" class="signup-link">User login</a>
</div>
        </div>
